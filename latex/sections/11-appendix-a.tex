...
Extract quantitative morphometric features from tissue imaging (histology, digital tomosynthesis) for treatment efficacy assessment. \\
...
\textit{Outputs:} Tracked keypoint trajectories, derived behavioral metrics (inter-animal distance, contact duration, locomotion speed), statistical comparisons. \\
