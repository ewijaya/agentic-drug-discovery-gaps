...
LLM-centric design treats the language model as central coordinator, invoking external tools via APIs. ChemCrow calls RDKit and PubChem \citep{bran2023chemcrow}. ChatInvent retrieves and synthesizes literature \citep{he2026chatinvent}. This works for text-based reasoning and stateless tools.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/fig4-multi-paradigm-architecture.pdf}
