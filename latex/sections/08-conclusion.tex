...
The past three years showed what is possible. The next three years will determine whether these systems generalize beyond demos. The gaps are engineering challenges. If the field meets them, agentic AI can become a transformative tool against disease. If not, it will remain a curiosity in practice.
