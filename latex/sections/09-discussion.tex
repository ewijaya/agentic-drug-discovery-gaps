...
Lakhan \citep{lakhan2025agentic} advocates for agentic AI adoption in biopharma. The adoption they advocate requires the engineering solutions we propose; without addressing the identified gaps, adoption will remain limited to settings that match current framework assumptions.
