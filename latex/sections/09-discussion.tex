...
Lakhan \citep{lakhan2025agentic} advocates for broader agentic adoption in biopharma. The adoption they advocate requires the design requirements identified in this analysis; without addressing the identified gaps, adoption will remain limited to settings that match current framework assumptions.
...
Second, open-source multi-paradigm orchestration frameworks. Integrating agent reasoning with existing workflow orchestration systems (\S\ref{sec:multiparadigm}), enabling inspection, diagnosis, and iterative improvement, would close the gap between workflow automation and intelligent orchestration.
