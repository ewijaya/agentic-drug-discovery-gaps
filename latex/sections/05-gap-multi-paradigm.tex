...
\begin{table}[htbp]
\centering
\caption{Computational Task Types: Agent Support vs Practitioner Need}
...
Effective interaction would be batch-mode, not chat. Bottlenecks are orchestrating end-to-end analyses, not formulating queries. Small biotechs managing dozens of projects require batch-mode automation with agents intervening only for human decisions (see \S\ref{sec:smallbiotech}).
