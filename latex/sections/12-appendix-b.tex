...
\label{appendix:capability-matrix}
...
Table~\ref{tab:dimension-summary} summarizes per-dimension coverage across all six frameworks. The sparsest dimensions, computational paradigm support (D2) and optimization framework (D5), reflect architectural limitations inherent to LLM-as-orchestrator designs: cannot support gradient-based training or multi-objective reasoning without fundamental changes.
